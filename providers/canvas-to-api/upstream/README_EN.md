...
5. Manually connect a browser session:
   ...
   Open your own Gemini share link in the browser that should carry the Gemini session, for example: `https://gemini.google.com/share/<your-share-id>`
...
After the container starts, you still need to manually open your own Gemini share link and connect a browser session, for example: `https://gemini.google.com/share/<your-share-id>`
...
3. Open your own Gemini share link in a browser, for example `https://gemini.google.com/share/<your-share-id>`.
